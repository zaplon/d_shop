...
class Shop(Application):
    ...
    def get_urls(self):
        urls = [
            url(r'^katalog/', include(self.catalogue_app.urls)),
            url(r'^koszyk/', include(self.basket_app.urls)),
            url(r'^zamowienie/', include(self.checkout_app.urls)),
            url(r'^konto/', include(self.customer_app.urls)),
            url(r'^szukaj/', include(self.search_app.urls)),
            url(r'^dashboard/', include(self.dashboard_app.urls)),
            url(r'^oferty/', include(self.offer_app.urls)),
